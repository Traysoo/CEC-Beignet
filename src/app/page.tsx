        ...
        <div className="relative">
          ...
          <div className="absolute top-20 right-0 w-[35%]">
            ...
            <p className="text-xl leading-relaxed">
              ...
              Notre approche permet de  traduire des enjeux systémiques en récits sensibles en mesurer l’impact environnemental et social, pour contribuer à nourrir un espace juste et équitable pour l’humanité.
            </p>
          </div>
